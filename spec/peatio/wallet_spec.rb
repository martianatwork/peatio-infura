RSpec.describe Peatio::Infura::Wallet do
  let(:wallet) { Peatio::Infura::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Infura::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Infura::Wallet::SUPPORTED_SETTINGS))
    end
  end
